...
public class AuthController {
    ...
    public void getUser(@RequestParam("code") String code) {
        ...
        try {
            ...
            list.add(new BasicNameValuePair("client_id", "087a84c999f49baf3b7c"));
            list.add(new BasicNameValuePair("client_secret", "5218b1f7cdea07f8f83f6f231aa282ca00f473c3"));
            ...
            post.addHeader("user-agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36");
            //执行请求内容
            ...
            get.setHeader("user-agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36");
